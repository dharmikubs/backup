...
const Teamdetail = () => {
    ...
    return (
        <>
            <div className={`font-Roboto flex justify-between items-center mb-5`}>
                <div className={`flex flex-col mb-4 sm:mb-0`}>
                    <span className={`text-lg sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-[500]`}>Team 1 Name</span>
                    <span className={`text-Grey text-xs sm:text-sm`}>ID #123456</span>
                </div>
                <nav className={`flex justify-between align-top`} aria-label="Breadcrumb">
                    <ol className={`inline-flex items-center sm:mb-0`}>
                        <li>
                            <div className={`flex items-center`}>
                                <Link to="/team" className={`text-xs sm:text-sm font-medium text-Grey`}>Sales Management</Link>
                            </div>
                        </li>
                        <span className={`mx-1 text-Grey text-sm`}>/</span>
                        <li>
                            <div className={`flex items-center`}>
                                <span className={`text-xs sm:text-sm font-medium text-Secondary`}>Team 1 Name</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div className={`relative table-shadow rounded-[5px] px-5 bg-white font-Roboto`}>
                <div className={`lg:flex w-full justify-between sm:py-6 p-4 lg:space-y-0 space-y-4  items-center`}>
                    <h3 className={`text-xl text-nowrap text-Black font-bold`}>Team Members (Sales Persons)</h3>
