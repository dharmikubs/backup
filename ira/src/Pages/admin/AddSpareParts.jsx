    ...
    return (
        <>
            <div className={`lg:flex justify-between items-center mb-8`}>
                <h2 className={`text-lg lg:text-2xl font-bold`}>Add Spare Part</h2>
                <nav className={`flex justify-between`} aria-label="Breadcrumb">
                    <ol className={`inline-flex items-center sm:mb-0`}>
                        ...
                        <li>
                            <div className={`flex items-center`}>
                                <span className={`text-sm font-bold text-[#3983336]`}>Add Spare Part</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div className={`relative overflow-x-auto shadow-custom rounded-[10px] bg-white`}>
                <div
                    ...
                    <h3 className={`text-lg text-nowrap  text-[#383336] font-bold`}>Spare Part
                        Details
                    </h3>
                </div>
