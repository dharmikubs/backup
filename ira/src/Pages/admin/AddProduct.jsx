    ...
    return (
        <>
            <div className={`lg:flex justify-between items-center mb-8`}>
                <h2 className={`text-lg lg:text-2xl font-bold`}>Add Product</h2>
                <nav className={`flex justify-between`} aria-label="Breadcrumb">
                    <ol className={`inline-flex items-center sm:mb-0`}>
                        ...
                        <li>
                            <div className={`flex items-center`}>
                                <span className={`text-sm font-bold text-[#3983336]`}>Add Product</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div className={`relative overflow-x-auto shadow-custom rounded-[10px] px-3 bg-white`}>
                <div
                    ...
                    <h3 className={`text-lg text-nowrap  text-[#383336] font-bold`}>Product
                        Details
                    </h3>
                </div>
